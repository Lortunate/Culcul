...
This project is indexed by GitNexus as **Culcul** (2759 symbols, 3435 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
