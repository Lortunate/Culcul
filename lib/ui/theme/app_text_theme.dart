...
class AppTextTheme {
  ...
  static TextTheme _buildTextTheme(Color primary, Color secondary, Color tertiary) {
    return TextTheme(
      ...
      headlineLarge: TextStyle(color: primary, fontSize: 22, fontWeight: FontWeight.bold),
      ...
      titleMedium: TextStyle(color: primary, fontSize: 15, fontWeight: FontWeight.w500),
      ...
      labelLarge: TextStyle(color: primary, fontSize: 14, fontWeight: FontWeight.w500),
