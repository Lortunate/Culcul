...
final $typed_data.Uint8List subtitleAiStatusDescriptor = $convert
    .base64Decode('ChBTdWJ0aXRsZUFpU3RhdHVzEggKBE5vbmUQABIMCghFeHBvc3VyZRAB');
...
final $typed_data.Uint8List videoMaskDescriptor = $convert.base64Decode(
    'CglWaWRlb01hc2sSEAoDY2lkGAEgASgJUgNjaWQSEgoEcGxhdBgCIAEoBVIEcGxhdBIQCgNmcH'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.bilibili.community.service.dm.v1.VideoSubtitleLan',
      '10': 'lan'
    },
    {'1': 'lan_doc', '3': 2, '4': 1, '5': 9, '10': 'lanDoc'},
    {'1': 'lan_doc_zh', '3': 3, '4': 1, '5': 9, '10': 'lanDocZh'},
  ],
};
...
final $typed_data.Uint8List videoSubtitleDescriptor = $convert.base64Decode(
    'Cg1WaWRlb1N1YnRpdGxlEkQKA2xhbhgBIAMoCzIyLmJpbGliaWxpLmNvbW11bml0eS5zZXJ2aW'
    'NlLmRtLnYxLlZpZGVvU3VidGl0bGVMYW5SA2xhbhIXCgdsYW5fZG9jGAIgASgJUgZsYW5Eb2MS'
    'HAoKbGFuX2RvY196aBgDIAEoCVIIbGFuRG9jWmg=');

@$core.Deprecated('Use videoSubtitleLanDescriptor instead')
const VideoSubtitleLan$json = {
  '1': 'VideoSubtitleLan',
  '2': [
    {'1': 'language', '3': 1, '4': 1, '5': 9, '10': 'language'},
    {'1': 'language_zh', '3': 2, '4': 1, '5': 9, '10': 'languageZh'},
    {'1': 'is_lock', '3': 3, '4': 1, '5': 8, '10': 'isLock'},
...
/// Descriptor for `VideoSubtitleLan`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List videoSubtitleLanDescriptor = $convert.base64Decode(
    'ChBWaWRlb1N1YnRpdGxlTGFuEhoKCGxhbmd1YWdlGAEgASgJUghsYW5ndWFnZRIfCgtsYW5ndW'
    'FnZV96aBgCIAEoCVIKbGFuZ3VhZ2VaaBIXCgdpc19sb2NrGAMgASgIUgZpc0xvY2sSEAoDdXJs'
    'GAQgASgJUgN1cmwSTwoJYWlfc3RhdHVzGAUgASgOMjIuYmlsaWJpbGkuY29tbXVuaXR5LnNlcn'
    'ZpY2UuZG0udjEuU3VidGl0bGVBaVN0YXR1c1IIYWlTdGF0dXM=');
...
const TextInput$json = {
  ...
  '2': [
    ...
    {'1': 'render_type', '3': 3, '4': 1, '5': 5, '10': 'renderType'},
...
final $typed_data.Uint8List textInputDescriptor = $convert.base64Decode(
    'CglUZXh0SW5wdXQSMQoUcG9ydHJhaXRfcGxhY2Vob2xkZXIYASABKAlSE3BvcnRyYWl0UGxhY2'
    'Vob2xkZXISMwoVbGFuZHNjYXBlX3BsYWNlaG9sZGVyGAIgASgJUhRsYW5kc2NhcGVQbGFjZWhv'
    'bGRlchIfCgtyZW5kZXJfdHlwZRgDIAEoBVIKcmVuZGVyVHlwZRIpChBwbGFjZWhvbGRlcl9wb3'
    'N0GAQgASgIUg9wbGFjZWhvbGRlclBvc3QSEgoEc2hvdxgFIAEoCFIEc2hvdxJACgZhdmF0YXIY'
    'BiABKAsyKC5iaWxpYmlsaS5jb21tdW5pdHkuc2VydmljZS5kbS52MS5BdmF0YXJSBmF2YXRhch'
    'JNCgtwb3N0X3N0YXR1cxgHIAEoDjIsLmJpbGliaWxpLmNvbW11bml0eS5zZXJ2aWNlLmRtLnYx'
    'LlBvc3RTdGF0dXNSCnBvc3RTdGF0dXMSPQoFbGFiZWwYCCABKAsyJy5iaWxpYmlsaS5jb21tdW'
    '5pdHkuc2VydmljZS5kbS52MS5MYWJlbFIFbGFiZWw=');
...
const TextInputV2$json = {
  ...
  '2': [
    ...
    {'1': 'post_status', '3': 6, '4': 1, '5': 5, '10': 'postStatus'},
    {
      '1': 'label',
      '3': 7,
      '4': 1,
...
final $typed_data.Uint8List textInputV2Descriptor = $convert.base64Decode(
    'CgtUZXh0SW5wdXRWMhIxChRwb3J0cmFpdF9wbGFjZWhvbGRlchgBIAEoCVITcG9ydHJhaXRQbG'
    'FjZWhvbGRlchIzChVsYW5kc2NhcGVfcGxhY2Vob2xkZXIYAiABKAlSFGxhbmRzY2FwZVBsYWNl'
    'aG9sZGVyEh8KC3JlbmRlcl90eXBlGAMgASgFUgpyZW5kZXJUeXBlEikKEHBsYWNlaG9sZGVyX3'
    'Bvc3QYBCABKAhSD3BsYWNlaG9sZGVyUG9zdBJACgZhdmF0YXIYBSABKAsyKC5iaWxpYmlsaS5j'
    'b21tdW5pdHkuc2VydmljZS5kbS52MS5BdmF0YXJSBmF2YXRhchIfCgtwb3N0X3N0YXR1cxgGIA'
    'EoBVIKcG9zdFN0YXR1cxI/CgVsYWJlbBgHIAEoCzIpLmJpbGliaWxpLmNvbW11bml0eS5zZXJ2'
    'aWNlLmRtLnYxLkxhYmVsVjJSBWxhYmVs');
...
final $typed_data.Uint8List toastV2Descriptor = $convert.base64Decode(
    ...
    '9uEkAKBmJ1dHRvbhgDIAEoCzIoLmJpbGliaWxpLmNvbW11bml0eS5zZXJ2aWNlLmRtLnYxLkJ1'
    'dHRvblIGYnV0dG9u');
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.bilibili.community.service.dm.v1.VideoSubtitleLan': VideoSubtitleLan$json,
