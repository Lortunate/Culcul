...
class _LiveApi implements LiveApi {
  ...
  Future<ApiResponse<Object>> getRecommendList({
    ...
    String? webLocation,
    int page = 1,
    int pageSize = liveRecommendPageSize,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'platform': platform,
  ...
  @override
  Future<ApiResponse<Object>> getAnchorInfo(int uid) async {
    final _extra = <String, dynamic>{};
  ...
  Future<ApiResponse<LiveGoldRankModel>> getOnlineGoldRank({
    ...
    required int roomId,
    int page = 1,
    int pageSize = liveGoldRankPageSize,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'ruid': ruid,
  ...
  Future<ApiResponse<LiveGuardListModel>> getGuardList({
    ...
    required int roomId,
    int page = 1,
    int pageSize = liveGuardListPageSize,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'ruid': ruid,
  ...
  Future<ApiResponse<void>> sendDanmaku({
    ...
    required int roomId,
    required int rnd,
    int color = _liveDanmakuDefaultColor,
    int fontsize = _liveDanmakuDefaultFontSize,
    int mode = _liveDanmakuDefaultMode,
    int bubble = _liveDanmakuDefaultBubble,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
