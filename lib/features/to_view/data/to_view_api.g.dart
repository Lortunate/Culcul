...
class _ToViewApi implements ToViewApi {
  _ToViewApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse<Object>> getToViewList() async {
