...
switch (_that) {
case _VideoDetailState():
return $default(_that.isLoading,_that.videoDetail,_that.playUrl,_that.error,_that.currentCid,_that.relatedVideos,_that.comments,_that.commentSort,_that.commentPage,_that.isCommentLoading,_that.hasMoreComments,_that.selectedQuality,_that.playbackSpeed,_that.availableQualities);}
}
