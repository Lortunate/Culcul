...
RouteBase get $mainShellRoute => StatefulShellRouteData.$route(
  ...
  branches: [
    ...
    StatefulShellBranchData.$branch(
      routes: [GoRouteData.$route(path: '/dynamic', factory: $DynamicRoute._fromState)],
    ),
    StatefulShellBranchData.$branch(
      routes: [GoRouteData.$route(path: '/ranking', factory: $RankingRoute._fromState)],
    ),
    StatefulShellBranchData.$branch(
      routes: [GoRouteData.$route(path: '/profile', factory: $ProfileRoute._fromState)],
    ),
  ],
);
...
RouteBase get $followingsRoute =>
    GoRouteData.$route(path: '/followings/:vmid', factory: $FollowingsRoute._fromState);
...
mixin $FollowingsRoute on GoRouteData {
  ...
  @override
  String get location =>
      GoRouteData.$location('/followings/${Uri.encodeComponent(_self.vmid.toString())}');
...
RouteBase get $followersRoute =>
    GoRouteData.$route(path: '/followers/:vmid', factory: $FollowersRoute._fromState);
...
mixin $FollowersRoute on GoRouteData {
  ...
  @override
  String get location =>
      GoRouteData.$location('/followers/${Uri.encodeComponent(_self.vmid.toString())}');
...
RouteBase get $userProfileRoute =>
    GoRouteData.$route(path: '/user/:mid', factory: $UserProfileRoute._fromState);
...
mixin $UserProfileRoute on GoRouteData {
  ...
  @override
  String get location =>
      GoRouteData.$location('/user/${Uri.encodeComponent(_self.mid.toString())}');
...
RouteBase get $settingsRoute => GoRouteData.$route(
  ...
  routes: [GoRouteData.$route(path: 'about', factory: $AboutRoute._fromState)],
);
...
RouteBase get $toViewRoute =>
    GoRouteData.$route(path: '/to-view', factory: $ToViewRoute._fromState);

mixin $ToViewRoute on GoRouteData {
  static ToViewRoute _fromState(GoRouterState state) => const ToViewRoute();

  @override
  String get location => GoRouteData.$location('/to-view');
...
RouteBase get $videoDetailRoute =>
    GoRouteData.$route(path: '/video/:bvid', factory: $VideoDetailRoute._fromState);
...
RouteBase get $liveRoomRoute =>
    GoRouteData.$route(path: '/live/:roomId', factory: $LiveRoomRoute._fromState);
...
mixin $LiveRoomRoute on GoRouteData {
  ...
  @override
  String get location =>
      GoRouteData.$location('/live/${Uri.encodeComponent(_self.roomId.toString())}');
...
RouteBase get $commentReplyRoute => GoRouteData.$route(
  path: '/video/:bvid/comment/:oid/:rootId',
...
mixin $CommentReplyRoute on GoRouteData {
  static CommentReplyRoute _fromState(GoRouterState state) => CommentReplyRoute(
    bvid: state.pathParameters['bvid']!,
    oid: int.parse(state.pathParameters['oid']!),
    rootId: int.parse(state.pathParameters['rootId']!),
    $extra: state.extra as CommentReplyRouteInput,
  );
  ...
  String get location => GoRouteData.$location(
    '/video/${Uri.encodeComponent(_self.bvid)}/comment/${Uri.encodeComponent(_self.oid.toString())}/${Uri.encodeComponent(_self.rootId.toString())}',
  );
...
RouteBase get $favoritesRoute => GoRouteData.$route(
  ...
  routes: [
    GoRouteData.$route(path: 'detail/:mediaId', factory: $FavoriteDetailRoute._fromState),
  ],
);

mixin $FavoritesRoute on GoRouteData {
  static FavoritesRoute _fromState(GoRouterState state) => const FavoritesRoute();
...
mixin $FavoriteDetailRoute on GoRouteData {
  static FavoriteDetailRoute _fromState(GoRouterState state) => FavoriteDetailRoute(
...
RouteBase get $notificationRoute => GoRouteData.$route(
  ...
  routes: [
    GoRouteData.$route(path: 'reply', factory: $ReplyNotificationRoute._fromState),
    GoRouteData.$route(path: 'at', factory: $AtNotificationRoute._fromState),
    GoRouteData.$route(path: 'like', factory: $LikeNotificationRoute._fromState),
    GoRouteData.$route(path: 'system', factory: $SystemNotificationRoute._fromState),
    GoRouteData.$route(path: 'chat/:talkerId', factory: $ChatRoute._fromState),
  ],
);

mixin $NotificationRoute on GoRouteData {
  static NotificationRoute _fromState(GoRouterState state) => const NotificationRoute();
...
mixin $ChatRoute on GoRouteData {
  static ChatRoute _fromState(GoRouterState state) => ChatRoute(
    ...
    $extra: state.extra as ChatRouteInput,
  );
...
String _$routerHash() => r'85f1ea078fc97d66e809ff95e169802b69a95e8a';
