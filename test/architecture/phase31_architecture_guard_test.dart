...
const _phase40AllowedDataApplicationImports = <String>{
  ...
  'lib/features/dynamic/data/dynamic_repository_impl.dart -> lib/features/dynamic/application/article_detail_port.dart',
  'lib/features/dynamic/data/dynamic_repository_impl.dart -> lib/features/dynamic/application/dynamic_detail_port.dart',
  ...
  'lib/features/favorites/data/fav_repository_impl.dart -> lib/features/favorites/application/favorites_port.dart',
  'lib/features/home/data/home_repository_impl.dart -> lib/features/home/application/home_port.dart',
  'lib/features/notification/data/notification_repository_impl.dart -> lib/features/notification/application/notification_chat_port.dart',
  'lib/features/notification/data/notification_repository_impl.dart -> lib/features/notification/application/notification_feed_port.dart',
  'lib/features/notification/data/notification_repository_impl.dart -> lib/features/notification/application/notification_private_session_port.dart',
  'lib/features/notification/data/notification_repository_impl.dart -> lib/features/notification/application/notification_system_notice_port.dart',
  'lib/features/notification/data/notification_repository_impl.dart -> lib/features/notification/application/notification_unread_count_port.dart',
  'lib/features/profile/data/profile_cache_repository.dart -> lib/features/profile/application/profile_cache_port.dart',
  'lib/features/profile/data/profile_repository_impl.dart -> lib/features/profile/application/user_space_port.dart',
