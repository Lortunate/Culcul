...
| `lib/features/home/presentation/widgets/live_view.dart:11` | `lib/features/live/application/live_recommend_provider.dart` | `new-feature-public-api` | Keep classified for the guard; home owns the live feed surface while live owns the recommendation provider. |
...
| `lib/features/home/presentation/widgets/home_video_actions.dart:6` | `lib/features/to_view/application/to_view_list_controller.dart` | `new-feature-public-api` | Keep classified for the guard; home owns the video action surface while to-view owns the watch-later application controller. |
...
| `lib/features/to_view/application/to_view_list_controller.dart:1` | `lib/features/auth/application/auth_session_providers.dart` | `approved-session-seam` | Keep classified for the guard; auth session state is the current cross-feature session seam. |
