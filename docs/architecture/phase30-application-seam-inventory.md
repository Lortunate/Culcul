...
| `lib/features/live/presentation/view_models/live_room_view_model.dart:15` | `lib/features/profile/application/presentation_contracts/profile_repository_impl.dart` | `approved-profile-seam` | Keep classified for the guard; live anchor lookup uses the profile presentation contract instead of a dead one-method adapter. |
