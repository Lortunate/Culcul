...
| `lib/features/live/presentation/view_models/live_room_view_model.dart:15` | `lib/features/profile/application/profile_user_card_lookup.dart` | `approved-profile-seam` | Keep classified for the guard; profile lookup is the current cross-feature profile seam. |
