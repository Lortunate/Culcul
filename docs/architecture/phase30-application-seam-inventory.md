...
| `lib/features/home/presentation/widgets/home_video_actions.dart:5` | `lib/features/to_view/application/watch_later_port_provider.dart` | `new-feature-public-api` | Keep classified for the guard; home owns the video action surface while to-view owns the watch-later port provider. |
